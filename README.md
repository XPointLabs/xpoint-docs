...
Deep отделяет прикладной протокол от транспорта. Первый production-релиз
ориентирован на XPoint; Direct P2P mesh и user-managed/on-prem инфраструктура
остаются более поздними архитектурными целями. Реализованные, UAT-only и ещё
недоступные возможности перечислены только в [матрице
