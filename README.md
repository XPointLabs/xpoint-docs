...
message path. Direct P2P является отдельной обязательной целью до v1, а
user-managed/on-prem инфраструктура — отдельной более поздней целью. Текущая
доступность указана в [матрице готовности](release-readiness.md).
